RSpec.describe 'allow method review' do 
    it 'can custmize return value for methods on doubles' do 
        calculator = double
        allow(calculator).to receive(:add).and_return(15) # it invoke a method add and it should return 15 what erver happend
